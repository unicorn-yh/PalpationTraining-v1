...
async def handle_client():
    ...
    try:
        while True:
            ...
            #data = await reader.readexactly(4)  # read the length of the incoming message
            ...
            #     raise Exception(f"Incomplete message received. Expected {message_length}, got {len(message)}")
